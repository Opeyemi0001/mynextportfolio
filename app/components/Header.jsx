  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      <motion.h3
        ...
        Hi! I'm Opeyemi Onanuga <Image src={assets.hand_icon} alt='hand icon' className='w-6' />
      </motion.h3>
      <motion.h1
      ...
      <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
        ...
        <motion.a
          ...
          href="/opeyemi_cv.pdf" download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black' >
